package com.sean_steve.mentalhealthpro.taskdetail
...
class TaskDetailViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val completed: LiveData<Boolean> = _task.map { input: Tasks? ->
    ...
    private fun computeResult(taskResult: Results<Tasks>): Tasks? {
